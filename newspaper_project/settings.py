...
SECRET_KEY = os.environ.get('SELECT_KEY','clave-por-defecto-solo-para-desarrollo-local')
...
CSRF_TRUSTED_ORIGINS = [
    'https://django-periodico.onrender.com',
    'https://*.onrender.com',
    'http://127.0.0.1:8000',
    'http://localhost:8000',
]
...
# --- NUEVA CONFIGURACIÓN DE ALMACENAMIENTO PARA DJANGO 5.x ---
STORAGES = {
    "default": {
